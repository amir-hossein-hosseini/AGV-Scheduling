# Function: Solving a special parallel machine for finding upper bound of AGV scheduling problem


def Pm_for_UB (n,m,d,t,Time):
    import cplex
    import timeit
    import numpy as np
    ...
    # Set 2: Completion time ---> There is the main different here: rhs is not 0, but t --> \sum x*(d+t) -t < c_max
    for i in range(1, m + 1):
        var = [None] * (n+1)
        coe = [None] * (n+1)
        h = 0
